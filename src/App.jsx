    ...
    <div className="grid-bg flex flex-col" style={{ height: '100vh', background: '#06060c', overflow: 'hidden' }}>
      ...
      {dbgVisible && (
        <div style={{
          ...
          fontFamily: 'monospace', fontSize: '0.6rem', color: '#a3e635',
          lineHeight: 1.6,
        }}>
          {dbgLines.length === 0
            ? <span style={{ color: 'rgba(148,163,184,0.5)' }}>no logs yet — tap Start Creating then a piano key</span>
