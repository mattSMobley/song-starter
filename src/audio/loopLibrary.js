...
export const DRUM_LOOPS = [
  {
    ...
    hits: [
      ...
      // Tom fill into bar 1 repeat
      { type: 'snare',  beat: 7 },   { type: 'tom-hi', beat: 7.25 },
      { type: 'tom-hi', beat: 7.5 }, { type: 'tom-lo', beat: 7.75 },
    ],
  },
  {
  ...
  },
  {
    ...
    hits: [
      ...
      { type: 'hihat', beat: 2.75 }, { type: 'snare', beat: 3 },
      { type: 'hihat', beat: 3.25 }, { type: 'hihat', beat: 3.5 },
      { type: 'kick',  beat: 3.75 },
      // Bar 2 — tom accent on beat 3
      { type: 'kick',  beat: 4 },    { type: 'hihat', beat: 4 },
      { type: 'hihat', beat: 4.25 }, { type: 'hihat', beat: 4.5 },
      { type: 'snare', beat: 5 },    { type: 'hihat', beat: 5 },
      { type: 'kick',  beat: 5.5 },  { type: 'kick',  beat: 5.75 },
      { type: 'hihat', beat: 6 },    { type: 'snare', beat: 6 },
      { type: 'kick',  beat: 6.5 },  { type: 'hihat', beat: 6.75 },
      { type: 'tom-hi', beat: 7 },   { type: 'snare', beat: 7 },
      { type: 'hihat', beat: 7.5 },
    ],
  },
  {
  ...
  },
  {
    ...
    hits: [
      ...
      { type: 'kick',  beat: 0 },  { type: 'hihat', beat: 0 },
      { type: 'hihat_open', beat: 0.5 },
      { type: 'kick',  beat: 1 },  { type: 'snare', beat: 1 }, { type: 'hihat', beat: 1 },
      { type: 'hihat_open', beat: 1.5 },
      { type: 'kick',  beat: 2 },  { type: 'hihat', beat: 2 },
      { type: 'hihat_open', beat: 2.5 },
      { type: 'kick',  beat: 3 },  { type: 'snare', beat: 3 }, { type: 'hihat', beat: 3 },
      { type: 'hihat_open', beat: 3.5 },
      { type: 'kick',  beat: 4 },  { type: 'hihat', beat: 4 },
      { type: 'hihat_open', beat: 4.5 },
      { type: 'kick',  beat: 5 },  { type: 'snare', beat: 5 }, { type: 'hihat', beat: 5 },
      { type: 'hihat_open', beat: 5.5 },
      { type: 'kick',  beat: 6 },  { type: 'hihat', beat: 6 },
      { type: 'hihat_open', beat: 6.5 },
      { type: 'kick',  beat: 7 },  { type: 'snare', beat: 7 }, { type: 'hihat', beat: 7 },
      { type: 'hihat_open', beat: 7.5 },
    ],
  },
  {
  ...
  },
  {
    ...
    hits: [
      ...
      { type: 'kick',  beat: 0 },   { type: 'hihat', beat: 0 },
      { type: 'hihat', beat: 0.5 }, { type: 'snare', beat: 1 },
      { type: 'hihat', beat: 1 },   { type: 'hihat', beat: 1.5 },
      { type: 'kick',  beat: 2 },   { type: 'hihat', beat: 2 },
      { type: 'kick',  beat: 2.5 }, { type: 'hihat', beat: 2.5 },
      ...
      { type: 'kick',  beat: 4 },   { type: 'hihat', beat: 4 },
      { type: 'hihat', beat: 4.5 }, { type: 'snare', beat: 5 },
      { type: 'hihat', beat: 5 },   { type: 'kick',  beat: 5.5 },
      { type: 'hihat', beat: 5.5 }, { type: 'hihat', beat: 6 },
      { type: 'kick',  beat: 6.5 }, { type: 'hihat', beat: 6.5 },
  ...
  },
  {
    ...
    hits: [
      ...
      { type: 'hihat', beat: 1.25 }, { type: 'snare', beat: 1.5 },
      { type: 'hihat', beat: 1.75 }, { type: 'kick',  beat: 2 },
      { type: 'hihat', beat: 2 },    { type: 'hihat', beat: 2.25 },
      { type: 'snare', beat: 2.75 }, { type: 'hihat', beat: 3 },
      { type: 'hihat', beat: 3.25 }, { type: 'snare', beat: 3.5 },
      { type: 'hihat', beat: 3.75 },
      // Bar 2 — same feel, slight variation
      { type: 'kick',  beat: 4 },    { type: 'hihat', beat: 4 },
      { type: 'hihat', beat: 4.25 }, { type: 'hihat', beat: 4.5 },
      { type: 'snare', beat: 4.75 }, { type: 'hihat', beat: 5 },
      { type: 'hihat', beat: 5.25 }, { type: 'snare', beat: 5.5 },
      { type: 'hihat', beat: 5.75 }, { type: 'kick',  beat: 6 },
      { type: 'hihat', beat: 6 },    { type: 'hihat', beat: 6.25 },
      { type: 'snare', beat: 6.75 }, { type: 'hihat', beat: 7 },
      { type: 'snare', beat: 7.5 },  { type: 'hihat', beat: 7.75 },
    ],
  },
  {
    id: 'drum-dnb', name: 'Drum & Bass', category: 'Drums', emoji: '🥁', bars: 2, bpm: 172,
    hits: [
      // Classic half-time snare (2 & 4 of 4/4) with syncopated kick, fast hats
      { type: 'kick',  beat: 0 },    { type: 'hihat', beat: 0 },
      { type: 'hihat', beat: 0.25 }, { type: 'hihat', beat: 0.5 },
      { type: 'hihat', beat: 0.75 }, { type: 'hihat', beat: 1 },
      { type: 'kick',  beat: 1.5 },  { type: 'hihat', beat: 1.5 },
      { type: 'snare', beat: 2 },    { type: 'hihat', beat: 2 },
      { type: 'hihat', beat: 2.5 },  { type: 'kick',  beat: 2.75 },
      { type: 'hihat', beat: 3 },    { type: 'kick',  beat: 3.5 },
      { type: 'hihat', beat: 3.5 },
      { type: 'snare', beat: 4 },    { type: 'hihat', beat: 4 },
      { type: 'hihat', beat: 4.25 }, { type: 'kick',  beat: 4.5 },
      { type: 'hihat', beat: 4.75 }, { type: 'hihat', beat: 5 },
      { type: 'kick',  beat: 5.5 },  { type: 'hihat', beat: 5.5 },
      { type: 'snare', beat: 6 },    { type: 'hihat', beat: 6 },
      { type: 'kick',  beat: 6.5 },  { type: 'hihat', beat: 6.75 },
      { type: 'kick',  beat: 7 },    { type: 'snare', beat: 7.5 },
      { type: 'hihat', beat: 7.5 },
    ],
  },
]
